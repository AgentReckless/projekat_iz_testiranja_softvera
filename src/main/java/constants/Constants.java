...
public class Constants {
    ...
    public static final String PA_URL = "https://www.polovniautomobili.com";
    ...
    // Labele / tekstovi - Google
    public static final String SEARCH_TERM = "Selenium Java";
    public static final String GOOGLE_TITLE_KEYWORD = "Selenium Java";
    ...
    public static final String PA_EXPECTED_CHASSIS = "Hečbek";
